      ...
      <div className="bg-[#FAF7F2] rounded-2xl max-w-md w-full shadow-2xl">
        ...
        {createdGroup ? (
          <div className="px-6 py-6">
            <div className="bg-white rounded-xl p-6 border border-[#E8DDD0] mb-4">
              <div className="text-center mb-4">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Check className="w-8 h-8 text-green-600" />
                </div>
                <h3 className="font-['var(--font-playfair)'] font-semibold text-[#1A1208] text-xl mb-1">
                  {createdGroup.name}
                </h3>
              ...
              <div className="bg-[#FFF3CD] rounded-lg p-4">
                <p className="text-sm font-['var(--font-dm-sans)'] text-[#8B4513] font-semibold mb-2">
                  Invite Link
                </p>
                <code className="text-xs bg-white px-3 py-2 rounded border border-[#E8DDD0] text-[#1A1208] font-mono block mb-3 break-all">
                  {`${window.location.origin}/join/${createdGroup.invite_token}`}
                </code>
                <button
                  onClick={copyInviteLink}
                  className="w-full px-4 py-2 bg-[#8B4513] text-white rounded-lg hover:bg-[#6B3410] transition-colors text-sm font-['var(--font-dm-sans)'] font-medium flex items-center justify-center gap-2"
                >
            ...
            <p className="text-sm text-[#6B5744] font-['var(--font-dm-sans)'] text-center mb-4">
              Share this link with anyone you want to add to the group. They'll join automatically when they open it.
            </p>

            <button
              onClick={handleDone}
              className="w-full bg-[#8B4513] text-white rounded-xl py-3 px-4 font-['var(--font-dm-sans)'] font-semibold hover:bg-[#6B3410] transition-all"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handleCreate} className="px-6 py-6 space-y-5">
            {/* Group Name */}
            <div>
              <label htmlFor="groupName" className="block text-sm font-['var(--font-dm-sans)'] font-semibold text-[#6B5744] mb-2">
                Group Name *
              </label>
              <input
                id="groupName"
            ...
            {/* Description */}
            <div>
              <label htmlFor="description" className="block text-sm font-['var(--font-dm-sans)'] font-semibold text-[#6B5744] mb-2">
                Description
              </label>
              <input
                id="description"
            ...
            {/* Group Fund */}
            <div>
              <label htmlFor="groupFund" className="block text-sm font-['var(--font-dm-sans)'] font-semibold text-[#6B5744] mb-2">
                Group Fund (₹)
              </label>
              <input
                id="groupFund"
